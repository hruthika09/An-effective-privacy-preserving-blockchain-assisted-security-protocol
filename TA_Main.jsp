...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style2">An Effective Privacy Preserving Blockchain Assisted Security Protocol for Cloud Based Digital Twin Environment </a></h1>
      </div>
      <div class="menu_nav">
        <ul>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/img1.jpg" width="177" height="381" alt="" class="fl" /></div>
