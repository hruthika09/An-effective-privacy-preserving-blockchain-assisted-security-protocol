    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/img1.jpg" width="177" height="302" alt="" class="fl" /></div>
          ...
          <div class="g2">
            <div class="gadget">
              ...
              <ul class="sb_menu">
				...
				<li><a href="CS_View_Location_Result.jsp">View Location Data Results </a></li>
