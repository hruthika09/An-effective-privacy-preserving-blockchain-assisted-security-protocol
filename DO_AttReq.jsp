...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html"><span class="style4">An Effective Privacy-Preserving Blockchain-Assisted Security Protocol for Cloud-Based Digital Twin Environment</span></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
  	...
  	try 
	{
		...
		%>
                <td><div class="style21 style6 style7">
                    <div align="center"><a href="DO_AttReq1.jsp?usid=<%=i%>"><%=s4%></a></div>
                </div></td>
                <%
