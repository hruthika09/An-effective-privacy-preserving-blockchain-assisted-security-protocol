					...
					if ( rs1.next() )
					   {
								...
								out.println("Data UserName Already Exits");							
							%>
					   ...
					   String s="Waiting";
					PreparedStatement ps=connection.prepareStatement("insert into downer(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,dgroup) values(?,?,?,?,?,?,?,?,?,?,?,?)");
